                        ...
                        <tbody>
                            @foreach($categories as $key => $category)
                                <tr>
                                    {{-- <td>{{ $category->id }}</td> --}}
                                    <td>{{$key + 1}}</td>
                                    <td><img src="{{asset($category->image)}}" width="60" /></td>
                                    <td>{{ $category->name_in_bengali }}</td>
                                    <td>{{ $category->name_in_english }}</td>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <div class="btn-group" role="group" aria-label="Second group">
                                            <a href="{{ url('category/edit', $category['id']) }}" class="btn btn-sm btn-primary edit-btn"><i class="fa fa-edit"></i></a>
