                ...
                <form action="{{ route('admin.category.store') }}" method="POST" role="form" enctype="multipart/form-data">
                    ...
                    <div class="tile-body">
                        <div class="form-group">
                            <label class="control-label" for="name_in_bengali">Category Name in Bengali <span class="m-l-5 text-danger"> *</span></label>
                    ...
                    <div class="tile-body">
                        <div class="form-group">
                            <label class="control-label" for="name_in_english">Category Name in English <span class="m-l-5 text-danger"> *</span></label>
